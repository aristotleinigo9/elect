const PASSWORD = 'Yan.03'; // Set your password here
let timer;
let userName, userId;
let countdownTimer;
let quizActive = true;
...
function handleVisibilityChange() {
    if (document.hidden) {
        alert("The test has been closed due to minimized page or another opened tab. Call your teacher or the proctor.");
        // closeQuiz()
    }
}
